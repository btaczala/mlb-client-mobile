...
function android_x86_qmake() {
     PATH=/mnt/external/projects/android/qt5/5.10.1/android_x86/bin/ qmake $@
}

function android_arm_qmake() {
     PATH=/mnt/external/projects/android/qt5/5.10.1/android_armv7/bin/ qmake $@
}
